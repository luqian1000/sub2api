...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	keys := []string{
		...
		SettingKeyModelSquareHomeEnabled,
		SettingKeyModelSquareNavEnabled,
	...
	return &PublicSettings{
		...
		ModelSquareHomeEnabled: settings[SettingKeyModelSquareHomeEnabled] == "true",
		ModelSquareNavEnabled:  settings[SettingKeyModelSquareNavEnabled] == "true",
...
func (s *SettingService) buildSystemSettingsUpdates(ctx context.Context, settings *SystemSettings) (map[string]string, error) {
	...
	updates[SettingKeyModelSquareHomeEnabled] = strconv.FormatBool(settings.ModelSquareHomeEnabled)
	updates[SettingKeyModelSquareNavEnabled] = strconv.FormatBool(settings.ModelSquareNavEnabled)
...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		// Model square public pricing entry points (default disabled; opt-in)
		SettingKeyModelSquareHomeEnabled: "false",
		SettingKeyModelSquareNavEnabled:  "false",
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	// Model square public pricing entry points (default: disabled; strict true)
	result.ModelSquareHomeEnabled = settings[SettingKeyModelSquareHomeEnabled] == "true"
	result.ModelSquareNavEnabled = settings[SettingKeyModelSquareNavEnabled] == "true"
